...
, bytestring, composition, data-default, directory, extra, hspec
, hspec-megaparsec, http-client, http-client-tls, http-types, lens
, megaparsec, MissingH, optparse-applicative, split, stdenv, text
}:
mkDerivation {
  pname = "tweet-hs";
  version = "0.5.3.4";
